...
//     loadCustomers();
//   }, []);
//   console.log(selectedCustomer, "cusr");
...
//   const customersWithMatchingOrders =
...
//             {searchType === "order" ? (
//               <p>
//                 Found {customersWithMatchingOrders.length} customer
//                 {customersWithMatchingOrders.length !== 1 ? "s" : ""} with
//                 matching orders
//               </p>
//             ) : (
//               <p>
...
//             {searchType === "order" &&
//               searchTerm &&
//               customersWithMatchingOrders.length === 0 && (
